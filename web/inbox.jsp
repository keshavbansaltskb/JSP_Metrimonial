                            ...
                            <div id="myTabContent" class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                    ...
                                    <%
                                        ...
                                        ResultSet rs = st.executeQuery("select * from inbox where to_email='" + email + "' Group BY email order by sn desc");
                                        while (rs.next()) {
                                            Statement st1 = cn.createStatement();
                                            ResultSet rs1 = st1.executeQuery("select * from details where email='" + rs.getString("email") + "'");
                                            if (rs1.next()) {
                                    %>
                                        ...
                                        <div class="thumb_top">
                                            ...
                                            <div class="jobs_right">
                                                ...
                                                <ul class="login_details1">
                                                    <li>Last Message : <%=rs.getString("dt")%></li>
                                                </ul>
                                                <p class="description"><span class="m_1">Message</span> :  <%=rs.getString("msg")%></p>
                                                <a href="view_profile.jsp?id=<%=rs1.getString("code")%>" style="margin-top:-10px"><div class="vertical" style="margin-top:-30px">View Profile</div></a>
