<%-- 
    Document   : sentmsg
    Created on : Jul 5, 2023, 10:06:33 AM
                            ...
                            <div id="myTabContent" class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                    ...
                                    <%
                                        ...
                                        ResultSet rs = st.executeQuery("select * from inbox where email='" + email + "' Group by to_email");
                                        while (rs.next()) {
                                            Statement st1 = cn.createStatement();
                                            ResultSet rs1 = st1.executeQuery("select * from details where email='" + rs.getString("to_email") + "'");
                                            if (rs1.next()) {
                                    %>
