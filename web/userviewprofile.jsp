<%-- 
    ...
    Created on : Jul 3, 2023, 2:34:16 PM
            ...
            <div class="container">
                <div class="breadcrumb1">
                    <ul>
                        ...
                        <li class="current-page">Profiles Which Is Viewed By You</li>
                    </ul>
                </div>
                            ...
                            <div id="myTabContent" class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                    ...
                                    <%
                                        ...
                                        ResultSet rs = st.executeQuery("select * from viewed where byuser='" + email + "' order by RAND()");
                                        while (rs.next()) {
                                            Statement st1 = cn.createStatement();
                                            ResultSet rs1 = st1.executeQuery("select * from details where code='" + rs.getString("viewuser") + "'");
                                            if (rs1.next()) {
                                    %>
