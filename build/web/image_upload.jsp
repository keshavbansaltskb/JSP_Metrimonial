            ...
            <div class="container">
                <div class="breadcrumb1">
                    <ul>
                        ...
                        <li class="current-page">Upload Your Image</li>
                    </ul>
                </div>
                <div class="services">
                    <div class="col-sm-6 login_left">
                        ...
                        <form method="post" ACTION="upload_image.jsp?id=<%=code%>&email=<%=email%>&pass=<%=pass%>" name="uploadForm" ENCTYPE='multipart/form-data' class="form">
                            <input type='file' name='uploadFile' class="table table-borderless">
