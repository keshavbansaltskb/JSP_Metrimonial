<%-- 
    Document   : inbox
    Created on : Mar 20, 2023, 11:09:02 PM
            ...
            <div class="container">
                <div class="breadcrumb1">
                    <ul>
                        ...
                        <li class="current-page">Favorite Profiles</li>
                    </ul>
                </div>
                            ...
                            <div id="myTabContent" class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                    ...
                                    <%
                                        ...
                                        ResultSet rs = st.executeQuery("select * from fav where email='" + email + "' order by sn desc");
                                        while (rs.next()) {
                                            Statement st1 = cn.createStatement();
                                            ResultSet rs1 = st1.executeQuery("select * from details where code='" + rs.getString("user_code") + "'");
                                            if (rs1.next()) {
                                    %>

                                    <div class="jobs-item with-thumb" id="<%=rs.getString("user_code")%>">
                                        <div class="thumb_top">
                                            <div class="thumb"><a href="view_profile.jsp?id=<%=rs1.getString("code")%>"><img src="upload/<%=rs1.getString("code")%>.jpg" class="img-responsive" alt=""/></a></div>
                                            <div class="jobs_right">
                                                ...
                                                <i class="fa fa-heart" id="<%=rs1.getString("code")%>" style="color:red;cursor:pointer"></i>
                                                <br>
                                                <label style="display:none" class="msgshow" id="r<%=rs1.getString("code")%>">Remove from favorite list</label>
                                            </div>
                                            <div class="clearfix"> </div>
                                        </div>
